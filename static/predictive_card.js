    ...
    modal.innerHTML = `
        <div id="crReportInner" style="background:#fff;border-radius:32px;width:95vw;max-width:1100px;max-height:95vh;display:flex;flex-direction:column;overflow:hidden;box-shadow:0 32px 80px rgba(0,0,0,0.25);">
            ...
            <div style="padding:14px 28px;background:#fff;border-top:1px solid #f1f5f9;display:flex;justify-content:space-between;align-items:center;flex-shrink:0;">
                <div style="font-size:11px;color:#94a3b8;font-weight:600;">HANUSPHERE Intelligence Hub &nbsp;·&nbsp; ${reportDate} &nbsp;·&nbsp; Confidential</div>
...
async function downloadCompanyReportPDF() {
    ...
    try {
        ...
        pdf.text('CONFIDENTIAL · HANUSPHERE Intelligence Hub', pageW - 8, 18, { align: 'right' });
        ...
        while (remainH > 0) {
            ...
            if (remainH > 0) {
                ...
                pdf.text('HANUSPHERE · Company Attendance Report · CONFIDENTIAL', pageW / 2, 5.5, { align: 'center' });
                yOffset = 10;
            }
        }
                ...
                <div style="display:flex; justify-content:space-between; align-items:flex-start; margin-bottom:32px;">
                    ...
                    <div style="text-align:right;">
                        <div style="background:rgba(255,255,255,0.1); border:1px solid rgba(255,255,255,0.2); padding:12px 20px; border-radius:14px; backdrop-filter:blur(10px);">
                            ...
                            <div style="font-size:9px; opacity:0.6; margin-top:4px;">HANUSPHERE Intelligence Hub</div>
                        </div>
                    </div>
                </div>
            ...
            <div style="padding:32px 40px;">
                ...
                <div style="border-top:2px solid #f1f5f9; padding-top:20px; display:flex; justify-content:space-between; align-items:center;">
                    <div>
                        ...
                        <div style="font-size:14px; font-weight:900; color:#6366f1;">HANUSPHERE Intelligence Hub</div>
